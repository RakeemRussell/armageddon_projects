...
# Reaches Parameter Store through the ssm Interface Endpoint - no NAT needed.
...
def home():
    ...
    return """
    <h2>EC2 (private) &rarr; RDS Notes App</h2>
    <p>/add?note=test</p>
    <p>/list</p>
    """
...
# Start CloudWatch Agent - binary already present on the golden AMI.
